...
export function KPICards({
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 print:grid-cols-4">
      ...
      <Card
        className={cn(
          "bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800 shadow-sm print:shadow-none print:border-slate-200 transition-all cursor-pointer hover:shadow-md",
      ...
      >
        ...
        <CardContent className="px-4 pb-4">
          ...
          <div className="flex items-center gap-2 mt-1">
            <Badge className="bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300 border-0 text-[10px] px-1.5 py-0 font-medium">
      ...
      >
        ...
        <CardContent className="px-4 pb-4">
          <div className="text-2xl font-bold text-sky-500 dark:text-sky-400 tabular-nums">
      ...
      >
        ...
        <CardContent className="px-4 pb-4">
          <div className="text-2xl font-bold text-orange-500 dark:text-orange-400 tabular-nums">
      ...
      >
        ...
        <CardContent className="px-4 pb-4">
          <div className="text-2xl font-bold text-green-500 dark:text-green-400 tabular-nums">
